...
public class Finalapply extends AppCompatActivity {
    ImageView img;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fixedactivity);

        //DIALOG BOX INTIALIZE
        dialog=new Dialog(Finalapply.this);
        ...
        okey.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                Toast.makeText(Finalapply.this, "Accepted !", Toast.LENGTH_SHORT).show();
                dialog.dismiss();
            }
        });
//
